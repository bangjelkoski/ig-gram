...
import HeartWrap from './styles';

const HeartOutline = function(props) {
    return (
        <HeartWrap onClick={props.toggleLiked}>
...
const HeartFull = function(props) {
    return (
        <HeartWrap onClick={props.toggleLiked} active={true}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
const Heart = function(props) {
    return props.liked ? <HeartFull {...props} /> : <HeartOutline {...props} />;
};
